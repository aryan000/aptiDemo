		...
		<div id="body">
			<div class="header">
				<div>
					<h1>Single Post</h1>
					<div class="article">
						<img src="/resources/images/martianrover-journey.jpg" alt="">
					...
					<div class="sidebar">
						<ul>
							<li>
								...
								<a href="blog"><img src="/resources/images/moon-satellite.jpg" alt=""></a>
								<h2>SOYUZ TMA-M</h2>
								<span>FEBRUARY 6, 2023</span>
							</li>
							<li>
								...
								<ul>
									<li>
										<a href="blog"><img src="/resources/images/alien-life.jpg" alt=""></a>
										<h2>ALIEN LIFE</h2>
										<span>FEBRUARY 3, 2023</span>
									</li>
									<li>
										<a href="blog"><img src="/resources/images/galaxy.jpg" alt=""></a>
										<h2>THE GALAXY</h2>
