			...
			<div class="header">
				<div>
					...
					<div class="article">
						<ul>
							<li>
								<a href="singlepost"><img src="/resources/images/astronaut.jpg" alt=""></a>
							...
							<li>
								<a href="singlepost"><img src="/resources/images/satellite-dish.jpg" alt=""></a>
					...
					<div class="sidebar">
						<ul>
							<li>
								...
								<a href="singlepost"><img src="/resources/images/moon-satellite.jpg" alt=""></a>
								<h2>SOYUZ TMA-M</h2>
								<span>FEBRUARY 6, 2023</span>
							</li>
							<li>
								...
								<ul>
									<li>
										<a href="singlepost"><img src="/resources/images/alien-life.jpg" alt=""></a>
										<h2>ALIEN LIFE</h2>
										<span>FEBRUARY 3, 2023</span>
									</li>
									<li>
										<a href="singlepost"><img src="/resources/images/galaxy.jpg" alt=""></a>
										<h2>THE GALAXY</h2>
